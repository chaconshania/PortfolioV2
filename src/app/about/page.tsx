  ...
  return (
    <div>
      <main className="grid max-w-[1800px] mx-auto grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-0 gap-8 p-6 w-full items-center">
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-6 pt-20 lg:pt-10 w-full md:col-span-3 items-center min-h-[40vh]">
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl lg:text-6xl text-[#333333] leading-[1.12]">
        ...
        */}
        <section className="hidden md:block w-full md:col-span-3">
          <DraggableCollage />
        </section>
      </main>
    </div>
